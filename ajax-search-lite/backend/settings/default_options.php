...
function asl_do_init_options() {
	...
	$options['asl_defaults'] = array(
		...
		'resultstype_def'                   => array(
			array(
				'option' => 'Vertical Results',
				'value'  => 'vertical',
			),
			array(
				'option' => 'Horizontal Results',
				'value'  => 'horizontal',
			),
			array(
				'option' => 'Isotopic Results',
				'value'  => 'isotopic',
			),
			array(
				'option' => 'Polaroid style Results',
				'value'  => 'polaroid',
			),
		),
		...
		'resultsposition_def'               => array(
			array(
				'option' => 'Hover - over content',
				'value'  => 'hover',
			),
			array(
				'option' => 'Block - pushes content',
				'value'  => 'block',
			),
		),
		...
		'wpml_display_missing_translations' => 'on_main_language', // 'on_main_language'|'on_all_languages'|'off'
