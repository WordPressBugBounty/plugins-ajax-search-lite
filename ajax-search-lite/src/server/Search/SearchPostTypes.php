...
class SearchPostTypes extends AbstractSearch {
	 ...
	 * This is needed to calculate the correct page in class-ASL-query.php
	...
	protected function doSearch(): void {
		...
		GROUP BY
			{args_groupby}
		ORDER BY {args_orderby} p_type_priority ASC, $orderby_primary, $orderby_secondary, id DESC
		LIMIT $query_limit";
