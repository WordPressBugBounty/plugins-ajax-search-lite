...
use ArrayAccess;
use WPDRMS\PluginCore\Traits\ObjectAsArrayTrait;
...
class SearchQueryArgs implements ArrayAccess {
	...
	/**
	 * @var 'on_main_language'|'on_all_languages'|'off'
	 */
	public string $wpml_display_missing_translations = 'on_main_language';
	...
	// ----------------------------------------------------------------
	/**
	 * Transforms all non Standard/ASCII quotation marks (“, ”, ‘, ’, „, ‚, ‛) to ASCII single/double ' and "
	 * in the search phrase
	 *
	 * @var bool
	 */
	public bool $transform_quotes = false;
	...
	/**
	 * Should be marked as true when the search is initiated via automated keyword suggestions
	 * @var bool
	 */
	public bool $is_suggestion_query = false;
